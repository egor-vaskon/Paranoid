//Project dependencies (including dependencies of all modules)
...
object Dependencies {
    ...
    val roomLibs = arrayListOf(roomRuntime, roomRxJava3, roomKtx)
    val androidTestDependecies = arrayListOf(extJunit, espressoCore)

    val appAnnotationProcessors = arrayListOf(roomCompiler)
    ...
    val appTestDependencies = arrayListOf(junit)
    val appAndroidTestDependencies = arrayListOf<String>().apply {
